...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full bg-[#F0F6F9] text-text-main selection:bg-secondary selection:text-white font-sans overflow-x-hidden">
      ...
      {/* 1. Hero Section */}
      <section className="relative w-full min-h-[90vh] flex items-center pt-24 lg:pt-32 pb-16 px-6 max-w-[1400px] mx-auto z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center w-full">
          <div className="flex flex-col gap-6 lg:gap-8">
            ...
            >
              ...
              <span className="text-sm font-semibold uppercase tracking-widest text-text-main/60">Digital Transformation Agency</span>
            </motion.div>
            ...
            <motion.h1 
              ...
              className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight text-text-main leading-[1.1]"
            >
              Automate operations. <br className="hidden md:block"/>
              Engineer <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">growth.</span>
            </motion.h1>
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-text-main/70 max-w-lg leading-relaxed"
            >
              We don't just build software. We engineer autonomous ecosystems and high-performance digital platforms that scale your business natively.
            </motion.p>
            ...
            >
              <Link href="/contact" className="w-full sm:w-auto px-8 py-4 bg-text-main text-white rounded-xl font-semibold text-lg hover:bg-primary transition-colors flex items-center justify-center gap-2 group">
                Start a Project
                <ArrowRight weight="bold" className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="#capabilities" className="w-full sm:w-auto px-8 py-4 bg-white border border-primary/20 text-text-main rounded-xl font-semibold text-lg hover:bg-primary/5 transition-colors flex items-center justify-center">
                Explore Services
              </Link>
            </motion.div>
          </div>
          ...
          <motion.div 
            ...
            className="relative w-full h-[500px] lg:h-[600px] rounded-3xl bg-white border border-primary/10 shadow-2xl overflow-hidden flex flex-col justify-between p-8 group"
          >
             <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-[80px] -z-10 group-hover:scale-150 transition-transform duration-1000" />
             <div className="absolute bottom-0 left-0 w-64 h-64 bg-secondary/5 rounded-full blur-[80px] -z-10 group-hover:scale-150 transition-transform duration-1000" />
             ...
             <div className="flex justify-between items-start">
               ...
               <div className="px-3 py-1 bg-[#F0F6F9] rounded-full text-xs font-mono font-medium text-text-main/50">SYSTEM_ACTIVE</div>
             </div>
             
             <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-2 bg-[#F0F6F9]/50 p-4 rounded-2xl border border-primary/5">
                  <span className="text-xs font-semibold text-text-main/50 uppercase tracking-widest">Process Efficiency</span>
                  <div className="flex items-end gap-2">
                    <span className="text-4xl font-bold text-text-main">+400%</span>
                    <TrendUp size={24} className="text-primary mb-1" weight="duotone" />
                  </div>
                </div>
                <div className="flex flex-col gap-2 bg-[#F0F6F9]/50 p-4 rounded-2xl border border-primary/5">
                  <span className="text-xs font-semibold text-text-main/50 uppercase tracking-widest">Manual Errors</span>
                  <div className="flex items-end gap-2">
                    <span className="text-4xl font-bold text-text-main">0.00%</span>
                    <ShieldCheck size={24} className="text-primary mb-1" weight="duotone" />
                  </div>
                </div>
             </div>
          </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col gap-16 text-center items-center">
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 w-full max-w-4xl">
             {["React & Next.js", "Node.js", "Odoo ERP", "OpenAI", "n8n / Make", "Tailwind CSS", "PostgreSQL", "AWS / Vercel"].map((tool, i) => (
                <div key={i} className="bg-[#F0F6F9] rounded-2xl p-6 flex flex-col items-center justify-center gap-3 hover:bg-white hover:shadow-xl border border-transparent hover:border-primary/10 transition-all duration-300">
                  <Code size={24} className="text-text-main/40" />
